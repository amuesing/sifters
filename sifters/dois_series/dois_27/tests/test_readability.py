...
from test_dois27 import PROJECT, notes, project_copy, run
...
class ReadabilityContracts(unittest.TestCase):
    def test_rhythm_and_pitch_unchanged_from_dois_25(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            # Velocity is deliberately NOT compared: dois_27 derives the weather from
            ...
            actual = {p.name.removeprefix('dois_27_'): notes(p)
