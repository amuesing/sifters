...
A readability refactor of Claude’s dois_25. The sieve, rhythm, accents, velocities,
...
synth parameters, not just loudness.
...
intervals. Weather and span residue choices remain explicit composition settings.
...
- `dois_26(gpt)_static_*`: fixed pitches A=36, B=37, C=38, D=39.
- `dois_26(gpt)_lattice_*`: pitches derived from the sieve’s lattice.
