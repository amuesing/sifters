#Generate an array where each indice is a sequentially ordered partial of the overtone seriesbased off of a fundamental frequency, and
#a range of included partials.
